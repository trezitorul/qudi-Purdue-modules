...
class PolarizationMotor_Dummy(MotorInterface):
    ...
    label = ConfigOption(name="label", default="Pol_Rot_Mot")
    position=0
...
##########Motor Interface Methods##########
    def get_constraints(self):
        ...
        axis0 = {}
        axis0['label'] = self.label    # it is very crucial that this label coincides
                                # with the label set in the config.
        axis0['unit'] = 'degrees'     # the SI units, only possible m or degree
        axis0['ramp'] = ['Sinus','Linear'], # a possible list of ramps
        axis0['pos_min'] = 0,
        axis0['pos_max'] = 360,  # that is basically the traveling range
        axis0['pos_step'] = 0.00694444,
        axis0['vel_min'] = 0,
        axis0['vel_max'] = 25 #deg/s,
        axis0['vel_step'] = 0.1,#Guess
    ...
    def move_rel(self,  param_dict):
        ...
        """
        target_pos=self.position + param_dict[self.label]
    ...
    def move_abs(self, param_dict):
        ...
        """
        self.set_position(param_dict[self.label])
    ...
    def get_pos(self, param_list=None):
        ...
        @return dict: with keys being the axis labels and item the current
                      position.
        """
        return {self.label:self.get_position()}
