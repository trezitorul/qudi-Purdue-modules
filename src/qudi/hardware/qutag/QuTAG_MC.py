...
class QuTAG():
    ...
    def __init__(self):
        ...
        file_path = "C:\\Users\\Ozymandias\\qudi-Purdue-modules\\src\\qudi\\hardware\\qutag\\DLL_64bit\\tdcbase.dll"
        ...
        print("Initialize and Start with quTAG device: ", self.err_dict[self.Initialize()] )#TODO move this to qutag qudi wrapper 
