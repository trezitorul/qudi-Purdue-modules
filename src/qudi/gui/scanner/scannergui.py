...
class ScannerGui(GuiBase):
    ...
    _resolution_step_size = ConfigOption(name='resolution_step_size', default='nm', missing='warn')
    # default options for 3 buttons
    _default_option_1 = ConfigOption(name='default1', missing='error')
    _default_option_2 = ConfigOption(name='default2', missing='error')
    _default_option_3 = ConfigOption(name='default3', missing='error')
    ...
    def _init_static_dockwidgets(self):
        if (not (isinstance(self._default_option_1, list) and isinstance(self._default_option_2, list) and isinstance(self._default_option_3, list))):
            self.log.error('Wrong type for default options. Needs to be list')
    ...
    @QtCore.Slot(dict)
    def set_galvo_target_position(self, target_pos):
        """
        Issues new target to logic and updates gui.
